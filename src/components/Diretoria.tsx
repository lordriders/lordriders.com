        ...
        <div className="row">
          <div className="col-md-3 text-center">
            <picture className="figure">
              <img
                src="/media/figs/diretoria/presi.webp"
          ...
          <div className="col-md-3 text-center">
            <picture className="figure">
              <img
                src="/media/figs/diretoria/Presi2024.jpg"
                className="figure-img img-fluid diretor"
                alt="Vice Presidente"
              />
            </picture>
          ...
          <div className="col-md-3 text-center">
            <picture className="figure">
              <img
                src="/media/figs/diretoria/psecretario.webp"
                className="figure-img img-fluid diretor"
                alt="Primeiro Secretário"
              />
            </picture>
            <h3 className="h3">Secretária</h3>
            <strong>Deby</strong>
            <p className="text-muted">(Deborah Braga Eitelwein)</p>
          </div>
          <div className="col-md-3 text-center">
            <picture className="figure">
              <img
                src="/media/figs/diretoria/crei.webp"
            ...
            <strong>Crei</strong>
            <p className="text-muted">(Mateus)</p>
          </div>
        </div>
      </div>
